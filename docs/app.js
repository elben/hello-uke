...
(function(exports) {
  ...
  var Note = (function () {
      function Note(value0, value1, value2) {
          this.value0 = value0;
          this.value1 = value1;
          this.value2 = value2;
      };
      Note.create = function (value0) {
          return function (value1) {
              return function (value2) {
                  return new Note(value0, value1, value2);
              };
          };
      };
      return Note;
  ...
  var showAccidental = new Data_Show.Show(function (v) {
      ...
      throw new Error("Failed pattern match at Notes line 18, column 1 - line 18, column 43: " + [ v.constructor.name ]);
  });
  var humanNote = function (v) {
      return v.value0 + Data_Show.show(showAccidental)(v.value1);
  };
  var gs = new Note("G", Sharp.value, 8);
  var gf = new Note("G", Flat.value, 6);
  var g = new Note("G", Natural.value, 7);
  var fs = new Note("F", Sharp.value, 6);
  var f = new Note("F", Natural.value, 5);
  ...
  var eqNote = new Data_Eq.Eq(function (x) {
      return function (y) {
          return x.value0 === y.value0 && Data_Eq.eq(eqAccidental)(x.value1)(y.value1) && x.value2 === y.value2;
      };
  });
  var ef = new Note("E", Flat.value, 3);
  var e = new Note("E", Natural.value, 4);
  var ds = new Note("D", Sharp.value, 3);
  var df = new Note("D", Flat.value, 1);
  var defaultAccidental = function (v) {
      if (v === 0) {
          return Flat.value;
      };
      if (v === 2) {
  ...
  var d = new Note("D", Natural.value, 2);
  var cs = new Note("C", Sharp.value, 1);
  var c = new Note("C", Natural.value, 0);
  var bf = new Note("B", Flat.value, 10);
  var b = new Note("B", Natural.value, 11);
  var as = new Note("A", Sharp.value, 10);
  var af = new Note("A", Flat.value, 8);
  var a = new Note("A", Natural.value, 9);
  var allNotes = [ c, cs, df, d, ds, ef, e, f, fs, gf, g, gs, af, a, as, bf, b ];
  var notes = [ [ c ], [ cs, df ], [ d ], [ ds, ef ], [ e ], [ f ], [ fs, gf ], [ g ], [ gs, af ], [ a ], [ as, bf ], [ b ] ];
  var findNoteForAccidental = function (pos) {
      return function (accidental) {
          return Control_Bind.bind(Data_Maybe.bindMaybe)(Data_Array.index(notes)(pos))(function (v) {
              var $47 = Data_Array.length(v) === 1;
              if ($47) {
                  return Data_Array.index(v)(0);
              };
              return Data_Foldable.find(Data_Foldable.foldableArray)(function (v1) {
                  return v1.value2 === pos && Data_Eq.eq(eqAccidental)(v1.value1)(accidental);
              })(v);
          });
      };
  };
  ...
  exports["Sharp"] = Sharp;
  exports["Flat"] = Flat;
  exports["defaultAccidental"] = defaultAccidental;
  exports["Note"] = Note;
  exports["c"] = c;
  exports["cs"] = cs;
  exports["df"] = df;
  ...
  exports["notes"] = notes;
  exports["humanNote"] = humanNote;
  exports["findNoteForAccidental"] = findNoteForAccidental;
...
(function(exports) {
  ...
  var Barre = (function () {
      function Barre(value0, value1, value2) {
          this.value0 = value0;
          this.value1 = value1;
          this.value2 = value2;
      };
      Barre.create = function (value0) {
          return function (value1) {
              return function (value2) {
                  return new Barre(value0, value1, value2);
              };
          };
      };
      return Barre;
  })();
  var Fingering = (function () {
      function Fingering(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      Fingering.create = function (value0) {
          return function (value1) {
              return new Fingering(value0, value1);
          };
      };
      return Fingering;
  })();
  var labelChordInterval = function (v) {
      if (v instanceof Triad) {
          return "Triad";
      };
      if (v instanceof Dom7) {
          return "7";
      };
      if (v instanceof Maj7) {
          return "M7";
      };
  ...
  var humanDivide = function (q) {
      return function (i) {
          if (q instanceof Minor) {
              if (i instanceof Triad) {
                  return "";
              };
              if (i instanceof Dom7) {
                  return "";
              };
              return "/";
          };
  ...
  var humanChordQuality = function (v) {
  ...
  var humanChordInterval = function (v) {
      ...
      return labelChordInterval(v);
  };
  var humanChordMod = function (q) {
      return function (i) {
          return humanChordQuality(q) + (humanDivide(q)(i) + humanChordInterval(i));
      };
  };
  var humanChord = function (chord) {
      return Notes.humanNote(chord.note) + humanChordMod(chord.quality)(chord.interval);
  };
  var getFingers = function (v) {
      return v.value1;
  };
  var getFingerPos = function (v) {
      if (v instanceof F) {
          return v.value0;
      };
      if (v instanceof X) {
          ...
          return function (c) {
              return function (d) {
                  return function (barre) {
                      return new Fingering(barre, [ a, b, c, d ]);
                  };
              };
          };
      };
  }; 
  var fingNoPlay = function (v) {
      if (v instanceof X) {
          return true;
      };
      return false;
  ...
  var fing = function (a) {
      return function (b) {
          return function (c) {
              return function (d) {
                  return new Fingering(Data_Maybe.Nothing.value, [ intToFinger(a), intToFinger(b), intToFinger(c), intToFinger(d) ]);
              };
          };
      };
  };
  var finb = function (a) {
      return function (b) {
          return function (c) {
              return function (d) {
                  return function (barre) {
                      return new Fingering(new Data_Maybe.Just(barre), [ intToFinger(a), intToFinger(b), intToFinger(c), intToFinger(d) ]);
                  };
              };
          };
      };
  };
  var defaultFingering = fing(0)(0)(0)(0);
  var chordQualityShow = new Data_Show.Show(function (v) {
      if (v instanceof Major) {
          return "Major";
      };
      if (v instanceof Minor) {
  ...
  var chordQualityOrd = new Data_Ord.Ord(function () {
      return chordQualityEq;
  }, function (x) {
      return function (y) {
          if (x instanceof Major && y instanceof Major) {
              return Data_Ordering.EQ.value;
          ...
          if (x instanceof Suspended) {
              return Data_Ordering.LT.value;
          };
          if (y instanceof Suspended) {
              return Data_Ordering.GT.value;
          };
          if (x instanceof Augmented && y instanceof Augmented) {
              return Data_Ordering.EQ.value;
  ...
  var chordIntervals = [ Triad.value, Dom7.value, Maj7.value, Second.value, Fourth.value, Dom9.value ];
  var chordIntervalEq = new Data_Eq.Eq(function (x) {
      return function (y) {
          if (x instanceof Triad && y instanceof Triad) {
              return true;
          };
          if (x instanceof Dom7 && y instanceof Dom7) {
              return true;
          };
          if (x instanceof Maj7 && y instanceof Maj7) {
              return true;
          };
  ...
  var chordIntervalOrd = new Data_Ord.Ord(function () {
      return chordIntervalEq;
  }, function (x) {
      return function (y) {
          if (x instanceof Triad && y instanceof Triad) {
              return Data_Ordering.EQ.value;
          };
          if (x instanceof Triad) {
              return Data_Ordering.LT.value;
          };
          if (y instanceof Triad) {
              return Data_Ordering.GT.value;
          };
          if (x instanceof Dom7 && y instanceof Dom7) {
              return Data_Ordering.EQ.value;
          };
          if (x instanceof Dom7) {
              return Data_Ordering.LT.value;
          };
          if (y instanceof Dom7) {
              return Data_Ordering.GT.value;
          };
          if (x instanceof Maj7 && y instanceof Maj7) {
              return Data_Ordering.EQ.value;
          };
          if (x instanceof Maj7) {
              return Data_Ordering.LT.value;
          };
          if (y instanceof Maj7) {
              return Data_Ordering.GT.value;
          };
          if (x instanceof Second && y instanceof Second) {
              return Data_Ordering.EQ.value;
          ...
          if (x instanceof Fourth) {
              return Data_Ordering.LT.value;
          };
          if (y instanceof Fourth) {
              return Data_Ordering.GT.value;
          };
          if (x instanceof Dom9 && y instanceof Dom9) {
              return Data_Ordering.EQ.value;
  ...
  var findUkeFingering = function (chord) {
      return Data_Maybe.fromMaybe(defaultFingering)(Control_Bind.bind(Data_Maybe.bindMaybe)(Control_Bind.bind(Data_Maybe.bindMaybe)(Data_Map_Internal.lookup(Data_Ord.ordInt)(chord.note.value2)(ukeChords))(Data_Map_Internal.lookup(chordQualityOrd)(chord.quality)))(Data_Map_Internal.lookup(chordIntervalOrd)(chord.interval)));
  };
  var ukeChordExists = function (p) {
      return function (q) {
          return function (i) {
              return Data_Maybe.maybe(false)(Control_Category.identity(Control_Category.categoryFn))(Control_Bind.bind(Data_Maybe.bindMaybe)(Control_Bind.bind(Data_Maybe.bindMaybe)(Data_Map_Internal.lookup(Data_Ord.ordInt)(p)(ukeChords))(Data_Map_Internal.lookup(chordQualityOrd)(q)))(function (m) {
                  return Control_Applicative.pure(Data_Maybe.applicativeMaybe)(Data_Map_Internal.member(chordIntervalOrd)(i)(m));
              }));
          };
      };
  };
  var buildChord = function (n) {
      return function (q) {
          return function (i) {
              return {
                  note: n,
  ...
  exports["humanChordQuality"] = humanChordQuality;
  exports["chordQualities"] = chordQualities;
  exports["Triad"] = Triad;
  exports["Dom7"] = Dom7;
  exports["Maj7"] = Maj7;
  ...
  exports["Dom9"] = Dom9;
  exports["chordIntervals"] = chordIntervals;
  exports["humanChordInterval"] = humanChordInterval;
  exports["labelChordInterval"] = labelChordInterval;
  exports["humanDivide"] = humanDivide;
  exports["humanChordMod"] = humanChordMod;
  exports["humanChord"] = humanChord;
  exports["F"] = F;
  exports["X"] = X;
  exports["getFingerPos"] = getFingerPos;
  exports["fingNoPlay"] = fingNoPlay;
  exports["Barre"] = Barre;
  exports["Fingering"] = Fingering;
  exports["defaultFingering"] = defaultFingering;
  exports["getBarre"] = getBarre;
  exports["getFingers"] = getFingers;
  exports["ukeChords"] = ukeChords;
  exports["fini"] = fini;
  exports["fing"] = fing;
  exports["finb"] = finb;
  exports["intToFinger"] = intToFinger;
  exports["findUkeFingering"] = findUkeFingering;
  exports["ukeChordExists"] = ukeChordExists;
  exports["chordQualityShow"] = chordQualityShow;
  exports["chordQualityEq"] = chordQualityEq;
  exports["chordQualityOrd"] = chordQualityOrd;
  exports["chordIntervalEq"] = chordIntervalEq;
  exports["chordIntervalOrd"] = chordIntervalOrd;
})(PS["Chords"] = PS["Chords"] || {});
(function(exports) {
  // Generated by purs version 0.12.0
  "use strict";
...
(function(exports) {
  ...
  var SelectNote = (function () {
      function SelectNote(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      SelectNote.create = function (value0) {
          return function (value1) {
              return new SelectNote(value0, value1);
          };
      };
      return SelectNote;
  })();
  var SelectChordQuality = (function () {
      function SelectChordQuality(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      SelectChordQuality.create = function (value0) {
          return function (value1) {
              return new SelectChordQuality(value0, value1);
          };
      };
      return SelectChordQuality;
  })();
  var SelectChordInterval = (function () {
      function SelectChordInterval(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      SelectChordInterval.create = function (value0) {
          return function (value1) {
              return new SelectChordInterval(value0, value1);
          };
      };
      return SelectChordInterval;
  })();
  var ChordSelectedQuery = (function () {
      function ChordSelectedQuery(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      ChordSelectedQuery.create = function (value0) {
          return function (value1) {
              return new ChordSelectedQuery(value0, value1);
          };
      };
      return ChordSelectedQuery;
  })();
  ...
  var ChordSelected = (function () {
      function ChordSelected(value0) {
          this.value0 = value0;
      };
      ChordSelected.create = function (value0) {
          return new ChordSelected(value0);
      };
  ...
  var ChordSelectedInput = (function () {
      function ChordSelectedInput(value0) {
          this.value0 = value0;
      };
      ChordSelectedInput.create = function (value0) {
          return new ChordSelectedInput(value0);
      };
      return ChordSelectedInput;
  })();
  var toMessage = function (v) {
      return function (v1) {
          if (v1.value0 instanceof Data_Maybe.Just && (v1.value1 instanceof Data_Maybe.Just && v1.value2 instanceof Data_Maybe.Just)) {
              return v(Chords.buildChord(v1.value0.value0)(v1.value1.value0)(v1.value2.value0));
          };
          return NoMessage.value;
      };
  }; 
  var setStateNote = function (note) {
      return function (v) {
          return new State(new Data_Maybe.Just(note), v.value1, v.value2);
      };
  };
  var setStateChordQuality = function (q) {
      return function (v) {
          return new State(v.value0, new Data_Maybe.Just(q), v.value2);
      };
  };
  var setStateChordInterval = function (i) {
      return function (v) {
          return new State(v.value0, v.value1, new Data_Maybe.Just(i));
      };
  };
  var selectableChordQualities = function (state) {
      if (state.value0 instanceof Data_Maybe.Just) {
          var qualitiesMap = Data_Maybe.fromMaybe(Data_Map_Internal.empty)(Data_Map_Internal.lookup(Data_Ord.ordInt)(state.value0.value0.value2)(Chords.ukeChords));
          return Data_Array.filter(function (q) {
              return Data_Map_Internal.member(Chords.chordQualityOrd)(q)(qualitiesMap);
          })(Chords.chordQualities);
      };
      return Chords.chordQualities;
  };
  var selectableChordIntervals = function (state) {
      if (state.value0 instanceof Data_Maybe.Just && state.value1 instanceof Data_Maybe.Just) {
          var intervalsMap = Data_Maybe.fromMaybe(Data_Map_Internal.empty)(Control_Bind.bind(Data_Maybe.bindMaybe)(Data_Map_Internal.lookup(Data_Ord.ordInt)(state.value0.value0.value2)(Chords.ukeChords))(Data_Map_Internal.lookup(Chords.chordQualityOrd)(state.value1.value0)));
          return Data_Array.filter(function (i) {
              return Data_Map_Internal.member(Chords.chordIntervalOrd)(i)(intervalsMap);
          })(Chords.chordIntervals);
      };
      return Chords.chordIntervals;
  };
  var rootNoteSelectorClasses = [ "selection", "root-note-selection", "btn", "clickable" ];
  var getStateNote = function (v) {
      return v.value0;
  };
  var getStateChordQuality = function (v) {
      return v.value1;
  };
  var getStateChordInterval = function (v) {
      return v.value2;
  };
  var defaultInterval = function (v) {
      if (v instanceof Chords.Suspended) {
          return Chords.Second.value;
      };
              ...
              return function (set) {
                  return function ($$default) {
                      return function (state) {
                          var v = get(state);
                          if (v instanceof Data_Maybe.Just) {
                              var selection = getSelection(state);
                              var $86 = Data_Foldable.elem(Data_Foldable.foldableArray)(dictEq)(v.value0)(selection);
                              if ($86) {
                                  return state;
                              };
                              return set(Data_Maybe.fromMaybe($$default)(Data_Array.index(selection)(0)))(state);
                          };
                          return state;
                      };
                  };
  ...
  var chordQualitySelectorClasses = [ "selection", "chord-quality-selection", "btn", "clickable" ];
  var chordIntervalSelectorClasses = [ "selection", "chord-interval-selection", "btn", "clickable" ];
  var component = (function () {
      var render = function (state) {
          var selectableNotes = Data_Array.filter(function (v) {
              return Data_Map_Internal.member(Data_Ord.ordInt)(v.value2)(Chords.ukeChords);
          })(Notes.allNotes);
          var isNoteSelected = function (n) {
              return Data_Maybe.maybe(false)(Data_Eq.eq(Notes.eqNote)(n))(getStateNote(state));
          };
          var isChordQualitySelected = function (q) {
              return Data_Maybe.maybe(false)(Data_Eq.eq(Chords.chordQualityEq)(q))(getStateChordQuality(state));
          };
          var isChordIntervalSelected = function (q) {
              return Data_Maybe.maybe(false)(Data_Eq.eq(Chords.chordIntervalEq)(q))(getStateChordInterval(state));
          };
          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "chord-selector" ]) ])([ Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.h3([  ])([ Halogen_HTML_Core.text("Root Note") ]) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "selector-section", "root-note-selector" ]) ])(Data_Functor.map(Data_Functor.functorArray)(function (note) {
              var classes = (function () {
                  var $92 = isNoteSelected(note);
                  if ($92) {
                      return Data_Array.snoc(rootNoteSelectorClasses)("selected");
                  };
                  return rootNoteSelectorClasses;
              })();
              return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes(classes), Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(SelectNote.create(note))) ])([ Halogen_HTML_Core.text(Notes.humanNote(note)) ]);
          })(selectableNotes)), Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.h3([  ])([ Halogen_HTML_Core.text("Quality") ]) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "selector-section", "chord-quality-selector" ]) ])(Data_Functor.map(Data_Functor.functorArray)(function (q) {
              var classes = (function () {
                  var $93 = isChordQualitySelected(q);
                  if ($93) {
                      return Data_Array.snoc(chordQualitySelectorClasses)("selected");
                  };
                  return chordQualitySelectorClasses;
              })();
              return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes(classes), Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(SelectChordQuality.create(q))) ])([ Halogen_HTML_Core.text(Data_Show.show(Chords.chordQualityShow)(q)) ]);
          })(selectableChordQualities(state))), Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.h3([  ])([ Halogen_HTML_Core.text("Interval") ]) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "selector-section", "chord-interval-selector" ]) ])(Data_Functor.map(Data_Functor.functorArray)(function (i) {
              var classes = (function () {
                  var $94 = isChordIntervalSelected(i);
                  if ($94) {
                      return Data_Array.snoc(chordIntervalSelectorClasses)("selected");
                  };
                  return chordIntervalSelectorClasses;
              })();
              return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes(classes), Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(SelectChordInterval.create(i))) ])([ Halogen_HTML_Core.text(Chords.labelChordInterval(i)) ]);
      ...
      var receiver = function (v) {
          ...
          if (v instanceof ChordSelectedInput) {
              return new Data_Maybe.Just(new ChordSelectedQuery(v.value0, Data_Unit.unit));
          };
          throw new Error("Failed pattern match at Component.ChordSelector line 147, column 3 - line 147, column 42: " + [ v.constructor.name ]);
      };
      var initialState = function (v) {
          if (v instanceof NoInput) {
              return new State(new Data_Maybe.Just(Notes.c), new Data_Maybe.Just(Chords.Major.value), new Data_Maybe.Just(Chords.Triad.value));
          };
          if (v instanceof ChordSelectedInput) {
              return new State(new Data_Maybe.Just(v.value0.note), new Data_Maybe.Just(v.value0.quality), new Data_Maybe.Just(v.value0.interval));
          };
          throw new Error("Failed pattern match at Component.ChordSelector line 143, column 3 - line 143, column 33: " + [ v.constructor.name ]);
      };
      var $$eval = function (v) {
          ...
          if (v instanceof SelectNote) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  var s2 = setStateNote(v.value0)(v1);
                  var s3 = considerStateSelection(Chords.chordQualityEq)(getStateChordQuality)(selectableChordQualities)(setStateChordQuality)(Chords.Major.value)(s2);
                  var s4 = considerStateSelection(Chords.chordIntervalEq)(getStateChordInterval)(selectableChordIntervals)(setStateChordInterval)(Chords.Triad.value)(s3);
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)(s4))(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.raise(toMessage(ChordSelected.create)(s4)))(function () {
                          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                      });
                  });
              });
          };
          if (v instanceof SelectChordQuality) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  var s2 = setStateChordQuality(v.value0)(v1);
                  var s3 = considerStateSelection(Chords.chordIntervalEq)(getStateChordInterval)(selectableChordIntervals)(setStateChordInterval)(Chords.Triad.value)(s2);
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)(s3))(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.raise(toMessage(ChordSelected.create)(s3)))(function () {
                          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                      });
                  });
              });
          };
          if (v instanceof SelectChordInterval) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  var state$prime = (function () {
                      var $109 = Data_Maybe.maybe(false)(function (i) {
                          return Data_Eq.eq(Chords.chordIntervalEq)(i)(v.value0);
                      })(getStateChordInterval(v1));
                      if ($109) {
                          return setStateChordInterval(Data_Maybe.maybe(Chords.Triad.value)(defaultInterval)(getStateChordQuality(v1)))(v1);
                      };
                      return setStateChordInterval(v.value0)(v1);
                  })();
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)(state$prime))(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.raise(toMessage(ChordSelected.create)(state$prime)))(function () {
                          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                      });
                  });
              });
          };
          if (v instanceof ChordSelectedQuery) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)(new State(new Data_Maybe.Just(v.value0.note), new Data_Maybe.Just(v.value0.quality), new Data_Maybe.Just(v.value0.interval))))(function () {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
              });
          };
  ...
  exports["State"] = State;
  exports["getStateNote"] = getStateNote;
  exports["getStateChordQuality"] = getStateChordQuality;
  exports["getStateChordInterval"] = getStateChordInterval;
  exports["setStateNote"] = setStateNote;
  exports["setStateChordQuality"] = setStateChordQuality;
  exports["setStateChordInterval"] = setStateChordInterval;
  exports["toMessage"] = toMessage;
  exports["Clear"] = Clear;
  exports["SelectNote"] = SelectNote;
  exports["SelectChordQuality"] = SelectChordQuality;
  exports["SelectChordInterval"] = SelectChordInterval;
  exports["ChordSelectedQuery"] = ChordSelectedQuery;
  exports["NoInput"] = NoInput;
  exports["ChordSelectedInput"] = ChordSelectedInput;
  exports["NoMessage"] = NoMessage;
  exports["ChordSelected"] = ChordSelected;
  exports["rootNoteSelectorClasses"] = rootNoteSelectorClasses;
  exports["chordQualitySelectorClasses"] = chordQualitySelectorClasses;
  exports["chordIntervalSelectorClasses"] = chordIntervalSelectorClasses;
  exports["selectableChordQualities"] = selectableChordQualities;
  exports["selectableChordIntervals"] = selectableChordIntervals;
  exports["considerStateSelection"] = considerStateSelection;
  exports["defaultInterval"] = defaultInterval;
  exports["component"] = component;
})(PS["Component.ChordSelector"] = PS["Component.ChordSelector"] || {});
(function(exports) {
  // Generated by purs version 0.12.0
  "use strict";
  var Chords = PS["Chords"];
  ...
  var Notes = PS["Notes"];
  var Prelude = PS["Prelude"];                 
  var chordHtml = function (v) {
      return function (q) {
          return function (i) {
              var mod = (function () {
                  if (i instanceof Chords.Triad) {
                      return [ Halogen_HTML_Core.text("") ];
                  };
                  if (i instanceof Chords.Dom7) {
                      return [ Halogen_HTML_Elements.sup([  ])([ Halogen_HTML_Core.text("7") ]) ];
                  };
                  if (i instanceof Chords.Maj7) {
                      return [ Halogen_HTML_Core.text("M"), Halogen_HTML_Elements.sup([  ])([ Halogen_HTML_Core.text("7") ]) ];
                  };
                  if (i instanceof Chords.Second) {
                      return [ Halogen_HTML_Core.text("2") ];
                  };
                  if (i instanceof Chords.Fourth) {
                      return [ Halogen_HTML_Core.text("4") ];
                  };
                  if (i instanceof Chords.Dom9) {
                      return [ Halogen_HTML_Core.text("9") ];
                  };
                  throw new Error("Failed pattern match at Component.Common line 27, column 11 - line 33, column 37: " + [ i.constructor.name ]);
              })();
              var keyType = (function () {
                  if (q instanceof Chords.Minor) {
                      return Halogen_HTML_Core.text("m");
                  };
                  if (q instanceof Chords.Suspended) {
                      return Halogen_HTML_Core.text("sus");
                  };
                  if (q instanceof Chords.Augmented) {
                      return Halogen_HTML_Core.text("sus");
                  };
                  return Halogen_HTML_Core.text("");
              })();
              ...
              return Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Halogen_HTML_Core.text(Notes.humanNote(v)), keyType, divide ])(mod);
          };
      };
  };
  exports["chordHtml"] = chordHtml;
...
(function(exports) {
  ...
  var step = function (pos) {
      return function (count) {
          return Data_EuclideanRing.mod(Data_EuclideanRing.euclideanRingInt)(pos + count | 0)(12);
      };
  };
  exports["step"] = step;
})(PS["Engine"] = PS["Engine"] || {});
(function(exports) {
  ...
  var ChordChange = (function () {
      function ChordChange(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      ChordChange.create = function (value0) {
          return function (value1) {
              return new ChordChange(value0, value1);
          };
      };
      return ChordChange;
  })();
  var RemoveChord = (function () {
      function RemoveChord(value0) {
          this.value0 = value0;
      };
      RemoveChord.create = function (value0) {
          return new RemoveChord(value0);
      };
      return RemoveChord;
  })();
  var IsOn = (function () {
  ...
  var renderCircle = function (classes) {
      return function (text) {
          return Halogen_HTML_Elements.span([ Halogen_HTML_Properties.classes(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ "circle" ])(classes)) ])([ Halogen_HTML_Elements.span([ Halogen_HTML_Properties.classes([ "circle-info" ]) ])([ Halogen_HTML_Core.text(Data_Maybe.fromMaybe("")(text)) ]) ]);
      };
  };
  var renderChordInfo = function (s) {
      var htmls = Component_Common.chordHtml(s.chord.note)(s.chord.quality)(s.chord.interval);
      return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "chord-meta-item", "chord-info" ]) ])(htmls);
  };
  var renderChordActions = Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "chord-actions" ]) ])([ Halogen_HTML_Elements.span([ Halogen_HTML_Properties.classes([ "chord-action-delete", "clickable" ]), Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(RemoveChord.create)) ])([ Halogen_HTML_Core.text("\u2716\ufe0e") ]) ]);
  var ordinalize = function (n) {
      if (n === 1 || n === 21) {
          return Data_Show.show(Data_Show.showInt)(n) + "st";
      };
      if (n === 2 || n === 22) {
          return Data_Show.show(Data_Show.showInt)(n) + "nd";
      };
      if (n === 3 || n === 23) {
          return Data_Show.show(Data_Show.showInt)(n) + "rd";
      };
      if (Data_Boolean.otherwise) {
          return Data_Show.show(Data_Show.showInt)(n) + "th";
      };
      throw new Error("Failed pattern match at Component.Fretboard line 165, column 1 - line 165, column 28: " + [ n.constructor.name ]);
  };
  var renderFretMarker = function (stringPos) {
      return function (fretPos) {
          var $7 = stringPos === 1 && (fretPos === 5 || (fretPos === 7 || (fretPos === 10 || fretPos === 15))) || (stringPos === 0 || stringPos === 2) && fretPos === 12;
          if ($7) {
              return Data_Maybe.Just.create(Halogen_HTML_Elements.span([ Halogen_HTML_Properties.classes([ "fret-marker" ]), Halogen_HTML_Properties.title(ordinalize(fretPos) + " fret") ])([ Halogen_HTML_Core.text("\u25c9") ]));
          };
          return Data_Maybe.Nothing.value;
      };
  };
  var numFretsToRender = function (s) {
      return Data_Ord.max(Data_Ord.ordInt)(4)(Data_Foldable.foldl(Data_Foldable.foldableArray)(function (m) {
          return function (f) {
              if (f instanceof Chords.X) {
                  return m;
              };
              if (f instanceof Chords.F) {
                  return Data_Ord.max(Data_Ord.ordInt)(m)(f.value0);
              };
              throw new Error("Failed pattern match at Component.Fretboard line 131, column 16 - line 133, column 31: " + [ f.constructor.name ]);
          };
      })(0)(Chords.getFingers(s.fingering)) + 1 | 0);
  };
  var barreOnFret = function (v) {
      return function (v1) {
          return function (v2) {
              if (v2 instanceof Data_Maybe.Just) {
                  return v2.value0.value0 === v1 && (v >= v2.value0.value1 && v <= v2.value0.value2);
              };
              return false;
          };
      };
  };
  var barreClassNames = function (stringPos) {
      return function (v) {
          if (stringPos === v.value1) {
              return [ "barre", "first" ];
          };
          if (stringPos === v.value2) {
              return [ "barre", "last" ];
          };
          if (stringPos >= v.value1 && stringPos <= v.value2) {
              return [ "barre" ];
          };
          if (Data_Boolean.otherwise) {
              return [  ];
          };
          throw new Error("Failed pattern match at Component.Fretboard line 35, column 1 - line 37, column 35: " + [ stringPos.constructor.name, v.constructor.name ]);
      };
  };
  var renderFret = function (stringPos) {
      return function (rootPos) {
          return function (fretPos) {
              return function (acc) {
                  return function (fing) {
                      return function (barre) {
                          var isBarreOnFret = barreOnFret(stringPos)(fretPos)(barre);
                          var higherFingerPlaying = function (bar) {
                              return function (fingerPos) {
                                  if (bar instanceof Data_Maybe.Just) {
                                      return fingerPos > bar.value0.value0;
                                  };
                                  return true;
                              };
                          };
                          var $27 = !(isBarreOnFret || (Chords.getFingerPos(fing) === fretPos || Chords.fingNoPlay(fing) && fretPos === 0));
                          if ($27) {
                              return Data_Maybe.Nothing.value;
                          };
                          var text = (function () {
                              if (fing instanceof Chords.F) {
                                  var $29 = isBarreOnFret && higherFingerPlaying(barre)(fing.value0);
                                  if ($29) {
                                      return Data_Maybe.Nothing.value;
                                  };
                                  return Data_Functor.map(Data_Maybe.functorMaybe)(Notes.humanNote)(Notes.findNoteForAccidental(Engine.step(fing.value0)(rootPos))(acc));
                              };
                              if (fing instanceof Chords.X) {
                                  return new Data_Maybe.Just("\u2716\ufe0e");
                              };
                              throw new Error("Failed pattern match at Component.Fretboard line 85, column 18 - line 93, column 7: " + [ fing.constructor.name ]);
                          })();
                          var classes = (function () {
                              if (isBarreOnFret) {
                                  return Data_Maybe.maybe([  ])(barreClassNames(stringPos))(barre);
                              };
                              var $32 = Chords.fingNoPlay(fing) && fretPos === 0;
                              if ($32) {
                                  return [ "no-play" ];
                              };
                              return [  ];
                          })();
                          return new Data_Maybe.Just(renderCircle(classes)(text));
                      };
                  };
              };
          };
  ...
  var renderFrets = function (stringPos) {
      return function (rootPos) {
          return function (numFrets) {
              return function (acc) {
                  return function (fing) {
                      return function (barre) {
                          return Data_Foldable.foldl(Data_Foldable.foldableArray)(function (htmls) {
                              return function (fretPos) {
                                  return Data_Array.snoc(htmls)(Halogen_HTML_Elements.span([ Halogen_HTML_Properties.classes([ "fret" ]) ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Maybe.maybe([  ])(function (h) {
                                      return [ h ];
                                  })(renderFretMarker(stringPos)(fretPos)))(Data_Maybe.maybe([  ])(function (h) {
                                      return [ h ];
                                  })(renderFret(stringPos)(rootPos)(fretPos)(acc)(fing)(barre)))));
                              };
                          })([  ])(Data_Array.range(0)(numFrets - 1 | 0));
                      };
                  };
              };
          };
  ...
  var renderString = function (state) {
      return function (stringPos) {
          return function (rootPos) {
              var fing = Data_Maybe.fromMaybe(Chords.X.value)(Data_Array.index(Chords.getFingers(state.fingering))(stringPos));
              var barre = Chords.getBarre(state.fingering);
              var acc = (function () {
                  var $34 = Data_Eq.eq(Notes.eqAccidental)(state.chord.note.value1)(Notes.Natural.value);
                  if ($34) {
                      return Notes.defaultAccidental(state.chord.note.value2);
                  };
                  return state.chord.note.value1;
              })();
              return Halogen_HTML_Elements.span([ Halogen_HTML_Properties.classes([ "string" ]) ])(renderFrets(stringPos)(rootPos)(numFretsToRender(state))(acc)(fing)(barre));
          };
      };
  };
  var component = (function () {
      var render = function (state) {
          var actionBar = (function () {
              if (state.displayActions) {
                  return [ renderChordActions ];
              };
              return [  ];
          })();
          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "fretboard" ]) ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)(actionBar)([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "chord-meta" ]) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "chord-meta-item" ]) ])([  ]), renderChordInfo(state) ]), renderString(state)(0)(7), renderString(state)(1)(0), renderString(state)(2)(4), renderString(state)(3)(9) ]));
      };
      var receiver = function (input) {
          return new Data_Maybe.Just(new ChordChange(input.chord, Data_Unit.unit));
      };
      var initialState = function (input) {
          return {
              chord: input.chord,
              displayActions: input.displayActions,
              fingering: Chords.findUkeFingering(input.chord)
          };
      };
      var $$eval = function (q) {
          if (q instanceof ChordChange) {
          ...
          if (q instanceof RemoveChord) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.raise(NotifyRemove.value))(function () {
                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(q.value0);
                  });
              });
          };
          if (q instanceof IsOn) {
              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(q.value0(true));
          };
          throw new Error("Failed pattern match at Component.Fretboard line 224, column 12 - line 235, column 24: " + [ q.constructor.name ]);
      };
      return Halogen_Component.component(Halogen_HTML_Core.bifunctorHTML)({
          initialState: initialState,
          render: render,
  ...
  exports["RemoveChord"] = RemoveChord;
  exports["IsOn"] = IsOn;
  exports["NotifyRemove"] = NotifyRemove;
  exports["barreClassNames"] = barreClassNames;
  exports["barreOnFret"] = barreOnFret;
  exports["renderCircle"] = renderCircle;
  exports["renderFret"] = renderFret;
  exports["renderChordInfo"] = renderChordInfo;
  exports["renderChordActions"] = renderChordActions;
  exports["numFretsToRender"] = numFretsToRender;
  exports["renderString"] = renderString;
  exports["renderFretMarker"] = renderFretMarker;
  exports["ordinalize"] = ordinalize;
  exports["renderFrets"] = renderFrets;
  exports["component"] = component;
})(PS["Component.Fretboard"] = PS["Component.Fretboard"] || {});
(function(exports) {
  // Generated by purs version 0.12.0
  "use strict";
  var Chords = PS["Chords"];
  var Component_Fretboard = PS["Component.Fretboard"];
  var Control_Applicative = PS["Control.Applicative"];
  var Control_Bind = PS["Control.Bind"];
  var Control_Monad_State_Class = PS["Control.Monad.State.Class"];
  var Data_Array = PS["Data.Array"];
  ...
  var Halogen_Query_HalogenM = PS["Halogen.Query.HalogenM"];
  var Prelude = PS["Prelude"];                 
  var FretboardChords = (function () {
      function FretboardChords(value0) {
          this.value0 = value0;
      };
      FretboardChords.create = function (value0) {
          return new FretboardChords(value0);
      };
      return FretboardChords;
  })();
  var NotifyRemove = (function () {
      function NotifyRemove(value0) {
          this.value0 = value0;
      };
      NotifyRemove.create = function (value0) {
          return new NotifyRemove(value0);
      };
      return NotifyRemove;
  })();
  var HandleFretboardMessage = (function () {
      function HandleFretboardMessage(value0, value1, value2) {
          this.value0 = value0;
          this.value1 = value1;
          this.value2 = value2;
      };
      HandleFretboardMessage.create = function (value0) {
          return function (value1) {
              return function (value2) {
                  return new HandleFretboardMessage(value0, value1, value2);
              };
          };
      };
      return HandleFretboardMessage;
  })();
  var ReplaceChords = (function () {
      function ReplaceChords(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      ReplaceChords.create = function (value0) {
          return function (value1) {
              return new ReplaceChords(value0, value1);
          };
      };
      return ReplaceChords;
  })();
  var component = (function () {
      var renderFretboard = function (fbState) {
          return Halogen_HTML.slot(fbState.id)(Component_Fretboard.component)({
              chord: fbState.chord,
              displayActions: true
          })(Halogen_HTML_Events.input(HandleFretboardMessage.create(fbState.id)));
      };
      var render = function (s) {
          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "added-fretboards" ]) ])([ Halogen_HTML_Elements.h3([  ])([ Halogen_HTML_Core.text((function () {
              var $5 = Data_Array["null"](s.fretboards);
              if ($5) {
                  return "";
              };
              return "Added Chords";
          })()) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "fretboards" ]) ])(Data_Functor.map(Data_Functor.functorArray)(renderFretboard)(s.fretboards)) ]);
      };
      var receiver = function (v) {
          return new Data_Maybe.Just(new ReplaceChords(v.value0, Data_Unit.unit));
      };
      var initialState = function (v) {
          return {
              fretboards: Data_Array.mapWithIndex(function (i) {
                  return function (c) {
                      return {
                          chord: c,
                          id: i
      ...
      var $$eval = function (v) {
          if (v instanceof HandleFretboardMessage) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (s) {
                  var $11 = {};
                  for (var $12 in s) {
                      if ({}.hasOwnProperty.call(s, $12)) {
                          $11[$12] = s[$12];
                      };
                  };
                  $11.fretboards = Data_Array.filter(function (fb) {
                      return fb.id !== v.value0;
                  })(s.fretboards);
                  return $11;
              }))(function () {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.raise(new NotifyRemove(v.value0)))(function () {
                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value2);
                  });
              });
          };
          if (v instanceof ReplaceChords) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                  ...
                  $17.fretboards = Data_Array.mapWithIndex(function (i) {
                      return function (c) {
                          return {
                              chord: c,
                              id: i
          ...
          throw new Error("Failed pattern match at Component.Fretboards line 74, column 3 - line 74, column 74: " + [ v.constructor.name ]);
      };
  ...
  exports["HandleFretboardMessage"] = HandleFretboardMessage;
  exports["ReplaceChords"] = ReplaceChords;
  exports["FretboardChords"] = FretboardChords;
  exports["NotifyRemove"] = NotifyRemove;
  exports["component"] = component;
})(PS["Component.Fretboards"] = PS["Component.Fretboards"] || {});
(function(exports) {
  // Generated by purs version 0.12.0
  "use strict";
  var Control_Alt = PS["Control.Alt"];
...
(function(exports) {
  ...
  var quality = Control_Alt.alt(Text_Parsing_Parser.altParserT(Data_Identity.monadIdentity))(Control_Alt.alt(Text_Parsing_Parser.altParserT(Data_Identity.monadIdentity))(Control_Alt.alt(Text_Parsing_Parser.altParserT(Data_Identity.monadIdentity))(Control_Alt.alt(Text_Parsing_Parser.altParserT(Data_Identity.monadIdentity))(Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(Text_Parsing_Parser_Combinators["try"](Data_Identity.monadIdentity)(Control_Alt.alt(Text_Parsing_Parser.altParserT(Data_Identity.monadIdentity))(Text_Parsing_Parser_String.string(Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity)("major"))(Text_Parsing_Parser_String.string(Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity)("maj"))))(function (v) {
      ...
      return Control_Applicative.pure(Text_Parsing_Parser.applicativeParserT(Data_Identity.monadIdentity))([ Chords.Suspended.value ]);
  }));
  var opts = function (res) {
      return function (v) {
          return Control_Applicative.pure(Text_Parsing_Parser.applicativeParserT(Data_Identity.monadIdentity))(res);
      };
  };
  var flat = function (v) {
      return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(Control_Alt.alt(Text_Parsing_Parser.altParserT(Data_Identity.monadIdentity))(Text_Parsing_Parser_String.string(Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity)("b"))(Text_Parsing_Parser_String.string(Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity)("\u266d")))(function (v1) {
          return Control_Applicative.pure(Text_Parsing_Parser.applicativeParserT(Data_Identity.monadIdentity))(Notes.Flat.value);
      });
  };
  var anyCase = function (n) {
      return Control_Alt.alt(Text_Parsing_Parser.altParserT(Data_Identity.monadIdentity))(Text_Parsing_Parser_String.string(Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity)(Data_String_Common.toLower(n)))(Text_Parsing_Parser_String.string(Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity)(Data_String_Common.toUpper(n)));
  };
  var interval = Control_Alt.alt(Text_Parsing_Parser.altParserT(Data_Identity.monadIdentity))(Control_Alt.alt(Text_Parsing_Parser.altParserT(Data_Identity.monadIdentity))(Control_Alt.alt(Text_Parsing_Parser.altParserT(Data_Identity.monadIdentity))(Control_Alt.alt(Text_Parsing_Parser.altParserT(Data_Identity.monadIdentity))(Control_Alt.alt(Text_Parsing_Parser.altParserT(Data_Identity.monadIdentity))(Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(Text_Parsing_Parser_Combinators["try"](Data_Identity.monadIdentity)(Text_Parsing_Parser_String.string(Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity)("dom7")))(opts([ Chords.Dom7.value ])))(Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(Text_Parsing_Parser_Combinators["try"](Data_Identity.monadIdentity)(Control_Alt.alt(Text_Parsing_Parser.altParserT(Data_Identity.monadIdentity))(Text_Parsing_Parser_String.string(Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity)("maj7"))(anyCase("M7"))))(opts([ Chords.Maj7.value ]))))(Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(Text_Parsing_Parser_Combinators["try"](Data_Identity.monadIdentity)(Text_Parsing_Parser_String.string(Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity)("7")))(function (v) {
      return Control_Applicative.pure(Text_Parsing_Parser.applicativeParserT(Data_Identity.monadIdentity))([ Chords.Dom7.value, Chords.Maj7.value ]);
  })))(Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(Text_Parsing_Parser_Combinators["try"](Data_Identity.monadIdentity)(Control_Alt.alt(Text_Parsing_Parser.altParserT(Data_Identity.monadIdentity))(Text_Parsing_Parser_String.string(Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity)("dom9"))(Text_Parsing_Parser_String.string(Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity)("9"))))(opts([ Chords.Dom9.value ]))))(Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(Text_Parsing_Parser_Combinators["try"](Data_Identity.monadIdentity)(Text_Parsing_Parser_String.string(Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity)("2")))(opts([ Chords.Second.value ]))))(Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(Text_Parsing_Parser_Combinators["try"](Data_Identity.monadIdentity)(Text_Parsing_Parser_String.string(Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity)("4")))(opts([ Chords.Fourth.value ])));
  var note = Control_Alt.alt(Text_Parsing_Parser.altParserT(Data_Identity.monadIdentity))(Control_Alt.alt(Text_Parsing_Parser.altParserT(Data_Identity.monadIdentity))(Control_Alt.alt(Text_Parsing_Parser.altParserT(Data_Identity.monadIdentity))(Control_Alt.alt(Text_Parsing_Parser.altParserT(Data_Identity.monadIdentity))(Control_Alt.alt(Text_Parsing_Parser.altParserT(Data_Identity.monadIdentity))(Control_Alt.alt(Text_Parsing_Parser.altParserT(Data_Identity.monadIdentity))(Control_Alt.alt(Text_Parsing_Parser.altParserT(Data_Identity.monadIdentity))(Control_Alt.alt(Text_Parsing_Parser.altParserT(Data_Identity.monadIdentity))(Control_Alt.alt(Text_Parsing_Parser.altParserT(Data_Identity.monadIdentity))(Control_Alt.alt(Text_Parsing_Parser.altParserT(Data_Identity.monadIdentity))(Control_Alt.alt(Text_Parsing_Parser.altParserT(Data_Identity.monadIdentity))(Control_Alt.alt(Text_Parsing_Parser.altParserT(Data_Identity.monadIdentity))(Control_Alt.alt(Text_Parsing_Parser.altParserT(Data_Identity.monadIdentity))(Control_Alt.alt(Text_Parsing_Parser.altParserT(Data_Identity.monadIdentity))(Control_Alt.alt(Text_Parsing_Parser.altParserT(Data_Identity.monadIdentity))(Control_Alt.alt(Text_Parsing_Parser.altParserT(Data_Identity.monadIdentity))(Text_Parsing_Parser_Combinators["try"](Data_Identity.monadIdentity)(Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(anyCase("c"))(sharp))(opts([ Notes.cs ]))))(Text_Parsing_Parser_Combinators["try"](Data_Identity.monadIdentity)(Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(anyCase("c"))(opts([ Notes.c, Notes.cs ])))))(Text_Parsing_Parser_Combinators["try"](Data_Identity.monadIdentity)(Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(anyCase("d"))(sharp))(opts([ Notes.ds ])))))(Text_Parsing_Parser_Combinators["try"](Data_Identity.monadIdentity)(Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(anyCase("d"))(flat))(opts([ Notes.df ])))))(Text_Parsing_Parser_Combinators["try"](Data_Identity.monadIdentity)(Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(anyCase("d"))(opts([ Notes.d, Notes.ds, Notes.df ])))))(Text_Parsing_Parser_Combinators["try"](Data_Identity.monadIdentity)(Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(anyCase("e"))(flat))(opts([ Notes.ef ])))))(Text_Parsing_Parser_Combinators["try"](Data_Identity.monadIdentity)(Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(anyCase("e"))(opts([ Notes.e, Notes.ef ])))))(Text_Parsing_Parser_Combinators["try"](Data_Identity.monadIdentity)(Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(anyCase("f"))(sharp))(opts([ Notes.fs ])))))(Text_Parsing_Parser_Combinators["try"](Data_Identity.monadIdentity)(Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(anyCase("f"))(opts([ Notes.f, Notes.fs ])))))(Text_Parsing_Parser_Combinators["try"](Data_Identity.monadIdentity)(Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(anyCase("g"))(sharp))(opts([ Notes.gs ])))))(Text_Parsing_Parser_Combinators["try"](Data_Identity.monadIdentity)(Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(anyCase("g"))(flat))(opts([ Notes.gf ])))))(Text_Parsing_Parser_Combinators["try"](Data_Identity.monadIdentity)(Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(anyCase("g"))(opts([ Notes.g, Notes.gs, Notes.gf ])))))(Text_Parsing_Parser_Combinators["try"](Data_Identity.monadIdentity)(Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(anyCase("a"))(sharp))(opts([ Notes.as ])))))(Text_Parsing_Parser_Combinators["try"](Data_Identity.monadIdentity)(Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(anyCase("a"))(flat))(opts([ Notes.af ])))))(Text_Parsing_Parser_Combinators["try"](Data_Identity.monadIdentity)(Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(anyCase("a"))(opts([ Notes.a, Notes.as, Notes.af ])))))(Text_Parsing_Parser_Combinators["try"](Data_Identity.monadIdentity)(Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(anyCase("b"))(flat))(opts([ Notes.bf ])))))(Text_Parsing_Parser_Combinators["try"](Data_Identity.monadIdentity)(Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(anyCase("b"))(opts([ Notes.b, Notes.bf ]))));
  var chords = function (max) {
      return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(note)(function (v) {
          return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(Text_Parsing_Parser_Combinators.option(Data_Identity.monadIdentity)(Chords.chordQualities)(quality))(function (v1) {
              return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(Text_Parsing_Parser_Combinators.optionMaybe(Data_Identity.monadIdentity)(Text_Parsing_Parser_String.string(Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity)("/")))(function (v2) {
                  return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(Text_Parsing_Parser_Combinators.option(Data_Identity.monadIdentity)(Chords.chordIntervals)(interval))(function (v3) {
                      var chrds = Data_Foldable.foldl(Data_Foldable.foldableArray)(function (acc) {
                          return function (v4) {
                      ...
                      return Control_Applicative.pure(Text_Parsing_Parser.applicativeParserT(Data_Identity.monadIdentity))(Data_Array.take(max)(chrds));
                  });
              });
          });
      });
  ...
  var parseString = function (n) {
      return function (s) {
          return Text_Parsing_Parser.runParser(Data_String_Common.replaceAll(" ")("")(s))(chords(n));
      };
  };
  var findChords = function (n) {
      return function (s) {
          var v = parseString(n)(s);
          if (v instanceof Data_Either.Right) {
              return v.value0;
          };
          if (v instanceof Data_Either.Left) {
          ...
          throw new Error("Failed pattern match at Parser line 17, column 18 - line 19, column 27: " + [ v.constructor.name ]);
      };
  };
...
(function(exports) {
  ...
  var Web_HTML_Window = PS["Web.HTML.Window"];
  var Web_UIEvent_KeyboardEvent = PS["Web.UIEvent.KeyboardEvent"];                 
  var QueryStringChanged = (function () {
      function QueryStringChanged(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      QueryStringChanged.create = function (value0) {
          return function (value1) {
              return new QueryStringChanged(value0, value1);
          };
      };
      return QueryStringChanged;
  })();
  var ChordSelected = (function () {
      function ChordSelected(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      ChordSelected.create = function (value0) {
          return function (value1) {
              return new ChordSelected(value0, value1);
          };
      };
      return ChordSelected;
  })();
  var HideResults = (function () {
      function HideResults(value0) {
          this.value0 = value0;
      };
      HideResults.create = function (value0) {
          return new HideResults(value0);
      };
      return HideResults;
  })();
  var ChordSelectedMessage = (function () {
      ...
      ChordSelectedMessage.create = function (value0) {
          return new ChordSelectedMessage(value0);
      };
  ...
  var component = (function () {
      ...
      var $$eval = function (query) {
          if (query instanceof QueryStringChanged) {
...
(function(exports) {
  ...
  "use strict";
  var Chords = PS["Chords"];
  var Component_ChordSelector = PS["Component.ChordSelector"];
  var Component_Fretboard = PS["Component.Fretboard"];
  var Component_Fretboards = PS["Component.Fretboards"];
  var Component_Search = PS["Component.Search"];
  var Control_Applicative = PS["Control.Applicative"];
  var Control_Bind = PS["Control.Bind"];
  var Control_Monad_State_Class = PS["Control.Monad.State.Class"];
  var Data_Array = PS["Data.Array"];
  ...
  var Notes = PS["Notes"];
  var Prelude = PS["Prelude"];                 
  var HandleChordSelector = (function () {
      function HandleChordSelector(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      HandleChordSelector.create = function (value0) {
          return function (value1) {
              return new HandleChordSelector(value0, value1);
          };
      };
      return HandleChordSelector;
  })();
  var HandleFretboard = (function () {
      function HandleFretboard(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      HandleFretboard.create = function (value0) {
          return function (value1) {
              return new HandleFretboard(value0, value1);
          };
      };
      return HandleFretboard;
  })();
  var HandleFretboards = (function () {
      function HandleFretboards(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      HandleFretboards.create = function (value0) {
          return function (value1) {
              return new HandleFretboards(value0, value1);
          };
      };
      return HandleFretboards;
  })();
  ...
  var AddChord = (function () {
      function AddChord(value0) {
          this.value0 = value0;
      };
      AddChord.create = function (value0) {
          return new AddChord(value0);
      };
      return AddChord;
  })();
  var initialChord = {
  ...
  var component = (function () {
      var render = function (state) {
          var chordAlreadyAdded = Data_Maybe.maybe(false)(Data_Function["const"](true))(Data_Array.findIndex(Data_Eq.eq(Data_Eq.eqRec()(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowNil)()(new Data_Symbol.IsSymbol(function () {
              ...
              return "note";
          }))(Notes.eqNote))()(new Data_Symbol.IsSymbol(function () {
              return "interval";
          }))(Chords.chordIntervalEq)))(state.chord))(state.chords));
          var onClickProp = (function () {
              if (chordAlreadyAdded) {
                  return [  ];
              };
              return [ Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(AddChord.create)) ];
          })();
          var addBtnClasses = [ "selection", "wide", "btn", (function () {
              if (chordAlreadyAdded) {
      ...
      var $$eval = function (v) {
          ...
          if (v instanceof HandleChordSelector && v.value0 instanceof Component_ChordSelector.NoMessage) {
              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
          };
          if (v instanceof HandleFretboard) {
              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
          };
  ...
  exports["AddChord"] = AddChord;
  exports["initialChord"] = initialChord;
  exports["component"] = component;
...
(function(exports) {
  ...
  var Web_DOM_ParentNode = PS["Web.DOM.ParentNode"];
  var Web_HTML = PS["Web.HTML"];                 
  var awaitRoot = Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitLoad)(function () {
      return Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.selectElement("div.app"))(function (v) {
