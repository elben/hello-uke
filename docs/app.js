...
(function(exports) {
  ...
  var humanChordInterval = function (v) {
      ...
      throw new Error("Failed pattern match at Chords line 80, column 1 - line 80, column 46: " + [ v.constructor.name ]);
  };
  ...
  var getFingerPos = function (v) {
      ...
      throw new Error("Failed pattern match at Chords line 104, column 1 - line 104, column 30: " + [ v.constructor.name ]);
  };
  ...
  var chordQualities = [ Major.value, Minor.value, Suspended.value, Augmented.value, Diminished.value ];

  // The dominant 9th (e.g. in C major: C, E, G, Bb, D)
  // | Maj9
  ...
  var chordIntervalOrd = new Data_Ord.Ord(function () {
      ...
      return function (y) {
          ...
          throw new Error("Failed pattern match at Chords line 77, column 8 - line 77, column 54: " + [ x.constructor.name, y.constructor.name ]);
      };
  });
...
(function(exports) {
  ...
  var initialState = new State(new Data_Maybe.Just(Notes.c), new Data_Maybe.Just(Chords.Major.value), new Data_Maybe.Just(Chords.Triad.value));
                  ...
                  return function ($$default) {
                      return function (state) {
                          ...
                          if (v instanceof Data_Maybe.Just) {
                              ...
                              var $79 = Data_Foldable.elem(Data_Foldable.foldableArray)(dictEq)(v.value0)(selection);
                              if ($79) {
                                  return state;
                              };
  ...
  var component = (function () {
      var render = function (state) {
          ...
          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "chord-selector" ]) ])([ Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.h3([  ])([ Halogen_HTML_Core.text("Root Note") ]) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "selector-section", "root-note-selector" ]) ])(Data_Functor.map(Data_Functor.functorArray)(function (note) {
              ...
              var classes = (function () {
                  var $86 = isChordQualitySelected(q);
                  if ($86) {
              ...
              var classes = (function () {
                  var $87 = isChordIntervalSelected(i);
                  if ($87) {
                      return Data_Array.snoc(chordIntervalSelectorClasses)("selected");
                  };
                  return chordIntervalSelectorClasses;
              })();
              return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes(classes), Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(SelectChordInterval.create(i))) ])([ Halogen_HTML_Core.text(Chords.humanChordInterval(i)) ]);
      ...
      var $$eval = function (v) {
          ...
          if (v instanceof SelectChordInterval) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  var state$prime = (function () {
                      var $98 = Data_Maybe.maybe(false)(function (i) {
          ...
          throw new Error("Failed pattern match at Component.ChordSelector line 204, column 10 - line 247, column 12: " + [ v.constructor.name ]);
      };
...
(function(exports) {
  ...
  var ordinalize = function (n) {
      ...
      throw new Error("Failed pattern match at Component.Fretboard line 168, column 1 - line 168, column 28: " + [ n.constructor.name ]);
  };
  ...
  var numFretsToRender = function (s) {
      return Data_Ord.max(Data_Ord.ordInt)(4)(Data_Foldable.foldl(Data_Foldable.foldableArray)(function (m) {
          return function (f) {
              ...
              throw new Error("Failed pattern match at Component.Fretboard line 134, column 16 - line 136, column 31: " + [ f.constructor.name ]);
          };
  ...
  var barreClassNames = function (stringPos) {
      return function (v) {
          ...
          throw new Error("Failed pattern match at Component.Fretboard line 38, column 1 - line 40, column 35: " + [ stringPos.constructor.name, v.constructor.name ]);
      };
  };
                  ...
                  return function (fing) {
                      return function (barre) {
                          ...
                          var text = (function () {
                              ...
                              throw new Error("Failed pattern match at Component.Fretboard line 88, column 18 - line 96, column 7: " + [ fing.constructor.name ]);
                          })();
                          var classes = (function () {
                              if (isBarreOnFret) {
  ...
  var component = (function () {
      ...
      var $$eval = function (q) {
          ...
          throw new Error("Failed pattern match at Component.Fretboard line 227, column 12 - line 238, column 24: " + [ q.constructor.name ]);
      };
      return Halogen_Component.component(Halogen_HTML_Core.bifunctorHTML)({
...
(function(exports) {
  ...
  var component = (function () {
      var render = function (state) {
          ...
          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "main-component" ]) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "top-component" ]) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "chord-selector-section" ]) ])([ Halogen_HTML["slot'"](Halogen_Component_ChildPath.cp1)(Data_Unit.unit)(Component_ChordSelector.component)(Data_Unit.unit)(Halogen_HTML_Events.input(HandleChordSelector.create)), Halogen_HTML_Elements.div(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Halogen_HTML_Properties.classes(addBtnClasses) ])(onClickProp))([ Halogen_HTML_Core.text((function () {
              if (chordAlreadyAdded) {
                  return "Already Added";
              };
              return "Add";
      ...
      var $$eval = function (v) {
          ...
          if (v instanceof HandleFretboards) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (s) {
                  ...
                  $20.chords = Data_FoldableWithIndex.foldlWithIndex(Data_FoldableWithIndex.foldableWithIndexArray)(function (i) {
                      return function (acc) {
                          return function (c) {
                              var $19 = v.value0.value0 === i;
                              if ($19) {
                                  return acc;
                              };
          ...
          if (v instanceof AddChord) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                  ...
                  $26.chords = Data_Array.snoc(st.chords)(st.chord);
                  return $26;
              }))(function () {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
              });
          };
          throw new Error("Failed pattern match at Component.App line 114, column 10 - line 129, column 12: " + [ v.constructor.name ]);
      };
...
(function(exports) {
  ...
  var awaitRoot = Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitLoad)(function () {
      return Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.selectElement("div.structure"))(function (v) {
